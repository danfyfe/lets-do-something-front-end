...
import { faAngleDoubleRight, faAngleDoubleLeft, faAngleDoubleUp, faAngleDoubleDown, faPlus, faSearch, faUserPlus, faUserCheck, faUserCircle } from '@fortawesome/free-solid-svg-icons'
...
const  App = () => {
  library.add(faAngleDoubleLeft, faAngleDoubleRight, faAngleDoubleUp, faAngleDoubleDown, faPlus, faSearch, faUserPlus, faUserCheck, faUserCircle);
  return (
  <>
    <Switch>
