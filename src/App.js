...
import { faAngleDoubleRight, faAngleDoubleLeft, faAngleDoubleUp, faAngleDoubleDown, faPlus, faMinus, faTimes, faSearch, faUserPlus, faUserCheck, faUserCircle, faThumbsUp, faThumbsDown, faArrowLeft } from '@fortawesome/free-solid-svg-icons'
...
const  App = () => {
  library.add(faAngleDoubleLeft, faAngleDoubleRight, faAngleDoubleUp, faAngleDoubleDown, faPlus, faMinus, faTimes, faSearch, faUserPlus, faUserCheck, faUserCircle, faThumbsUp, faThumbsDown, faArrowLeft);
  return (
  <>
    <Switch>
